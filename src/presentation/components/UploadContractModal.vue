<template>
    <el-card class="max-w-md mx-auto shadow-lg">
      ...
      >
        ...
        <p v-else class="text-blue-600 font-semibold">{{ archivo.name }}</p>
      </div>
  ...
  export default {
    setup() {
      ...
      return { archivo, fileInput, mensaje, errores, subiendo, progreso, onDragOver, onDragLeave, onDrop, onFileChange, seleccionarArchivo, subirArchivo };
    },
  };
  </script>
